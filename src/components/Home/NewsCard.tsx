  ...
  const data: Data[] = [
    {
      id: 1,
      title: "秋季旅遊，豪華享受方案",
      image: `${import.meta.env.BASE_URL}images/web/news1.webp`, 
      description:
    ...
    },
    {
      id: 2,
      title: "輕鬆住房專案",
      image: `${import.meta.env.BASE_URL}images/web/news2.webp`, 
      description:
    ...
    },
    {
      id: 3,
      title: "耶誕快樂，住房送禮",
      image: `${import.meta.env.BASE_URL}images/web/news3.webp`,
      description:
