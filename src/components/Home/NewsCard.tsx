import news1 from "@/assets/images/web/news1.webp";
import news2 from "@/assets/images/web/news2.webp";
import news3 from "@/assets/images/web/news3.webp";
  ...
  return (
    <div>
      {data.map((item, index) => (
        <div
          key={index}
          className="xxl:flex xxl:flex-row gap-2 mb-3 xxl:mb-6 xxl:w-[53rem] w-full"
        >
          <img
