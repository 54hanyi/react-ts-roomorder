    ...
    <>
      <div className="bg-black pt-[4rem] h-832 w-full">
        <div className="relative bg-[url('/images/web/about.png')] bg-contain bg-no-repeat bg-center h-576 w-full">
          ...
          <div className="absolute bg-gradient-to-b from-neutral-120/80 to-primary-100/80 rounded-br-none rounded-[4rem] border-white border-l border-b right-48 top-28 w-752 h-500">
            <div className='flex items-start text-white text-h1 px-12 pt-10 pb-8'>
            ...
            <div className='text-h6 text-white px-12 py-3'>
            ...
            <div className='text-h6 text-white px-12 py-4'>
