...
import map from "@/assets/images/web/map.webp";
import car from "@/assets/images/web/car.png";
import train from "@/assets/images/web/train.png";
import luxurycar from "@/assets/images/web/luxurycar.png";
        ...
        <div className="pt-20 px-10 lg:pt-28  lg:pl-48">
          <div className="relative flex flex-col items-start text-h1 text-primary-100">
            ...
            <img
              src={DecoLine2}
              alt="Line"
              className="absolute top-12 left-28 w-48"
              loading="lazy"
            />
          </div>

          <div className="lg:mt-20 mt-10 w-full lg:w-[70rem]">
            <p className="text-white text-body pb-3">
              台灣高雄市新興區八角壓路87號
            </p>
            <img
              src={map}
              alt=""
              className="block rounded-sm lg:h-[20rem] h-[12rem] mx-auto"
              loading="lazy"
            />

            <div className="lg:flex mt-6">
              <div className="text-white lg:w-1/3 p-2 lg:p-4">
                <img src={car} alt="" className="pb-4" />
              ...
              <div className="text-white lg:w-1/3 p-2 lg:p-4">
                <img src={train} alt="" className="pb-4" />
              ...
              <div className="text-white lg:w-1/3 p-2 lg:p-4">
                <img src={luxurycar} alt="" className="pb-4" />
                <p className="text-h5">禮賓車服務</p>
                <p className="text-body">
                  享樂酒店提供禮賓專車接送服務，但因目的地遠近會有不同的收費，請撥打電話將由專人為您服務洽詢專線：
                </p>
