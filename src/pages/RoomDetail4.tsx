        ...
        <div className="p-16">  
          <div className="flex gap-2">
            ...
            <div className="grid grid-rows-2 grid-flow-col gap-2 w-[45%]">
              <img
                src="/images/web/room3-2.png"
                alt="Room View"
                className="w-full h-full object-cover rounded-lg col-span-2"
              />
              <img
                src="/images/web/room3-3.png"
                alt="Room View"
                className="w-full h-full object-cover rounded-lg col-span-2"
              />
              <img
                src="/images/web/room3-4.png"
                alt="Room View"
                className="w-full h-full object-cover rounded-lg col-span-2"
              />
              <img
                src="/images/web/room3-5.png"
                alt="Room View"
                className="w-full h-full object-cover rounded-lg col-span-2"
              />
            </div>
          ...
          <div className="flex my-16 py-8 gap-20 justify-center">
            <div className="flex flex-col gap-10 w-[45%]">
              <RoomDetailInfo roomList={roomList[3]}/>
            </div>

            <div className="w-[30%]">
              <RoomDetailBox roomList={roomList[3]}/>
            </div>
          </div>
        </div>
      </div>
