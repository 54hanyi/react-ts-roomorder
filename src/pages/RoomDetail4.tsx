        ...
        <div className="p-16">  
          ...
          <div className="flex my-16 py-8 gap-20 justify-center">
            <div className="flex flex-col gap-10 w-[45%]">
              <div className="my-3">
                <p className="text-h1 mb-2">{roomList[3].title}</p>
                ...
                <div className="flex gap-5">
                  <div className="border-none bg-white border rounded-[0.6rem] w-20 h-20 pl-3 pt-4">
                    <IconButton
                      ...
                      disabled={true}
                    />
                    <p className="text-body font-bold">{roomList[3].size} 坪</p>
                  </div>
                  <div className="border-none bg-white border rounded-[0.6rem] w-20 h-20 pl-3 pt-4">
                    <IconButton
                      name="ic_Bed"
                      ...
                      disabled={true}
                    />
                    <p className="text-body font-bold">{roomList[3].bed} 張大床</p>
                  </div>
                  <div className="border-none bg-white border rounded-[0.6rem] w-20 h-20 pl-3 pt-4">
                    <IconButton
                      name="ic_Person"
                      ...
                      disabled={true}
                    />
                    <p className="text-body font-bold">{roomList[3].people} 人</p>
                  </div>
                </div>
              </div>
