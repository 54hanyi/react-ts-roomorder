        ...
        <div className="p-16">  
          <div className="flex gap-2">
            ...
            <div className="grid grid-rows-2 grid-flow-col gap-2 w-[45%]">
              <img
                src="/images/web/room5-2.png"
                alt="Room View"
                className="w-full h-full object-cover rounded-lg col-span-2"
              />
              <img
                src="/images/web/room5-3.png"
                alt="Room View"
                className="w-full h-full object-cover rounded-lg col-span-2"
              />
              <img
                src="/images/web/room5-4.png"
                alt="Room View"
                className="w-full h-full object-cover rounded-lg col-span-2"
              />
              <img
                src="/images/web/room5-5.png"
                alt="Room View"
                className="w-full h-full object-cover rounded-lg col-span-2"
              />
            </div>
          ...
          <div className="flex my-16 py-8 gap-20 justify-center">
            <div className="flex flex-col gap-10 w-[45%]">
              <div className="my-3">
                <p className="text-h1 mb-2">{roomList[4].title}</p>
                <p className="text-body">{roomList[4].content}</p>
              </div>
                ...
                <div className="flex gap-5">
                  <div className="border-none bg-white border rounded-[0.6rem] w-20 h-20 pl-3 pt-4">
                    <IconButton
                      ...
                      disabled={true}
                    />
                    <p className="text-body font-bold">{roomList[4].size} 坪</p>
                  </div>
                  <div className="border-none bg-white border rounded-[0.6rem] w-20 h-20 pl-3 pt-4">
                    <IconButton
                      name="ic_Bed"
                      ...
                      disabled={true}
                    />
                    <p className="text-body font-bold">{roomList[4].bed} 張大床</p>
                  </div>
                  <div className="border-none bg-white border rounded-[0.6rem] w-20 h-20 pl-3 pt-4">
                    <IconButton
                      name="ic_Person"
                      ...
                      disabled={true}
                    />
                    <p className="text-body font-bold">{roomList[4].people} 人</p>
                  </div>
                </div>
              </div>
            ...
            <div className="w-[30%]">
              <div className="h-[30rem] bg-white rounded-[1.2rem] px-8 py-10">
                ...
                <div className="mt-6 text-neutral-80">
                  <p className="text-h2 mb-2">{roomList[4].title}</p>
                  <p className="text-body">{roomList[4].content}</p>
                </div>
                <div className="mt-6">
                  <div className="flex gap-2">
